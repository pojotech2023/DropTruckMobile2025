...
@AndroidEntryPoint
class OntheRoadFragment : BaseFragment(), TripsAdapter.TripsInterface {
    ...
    override fun onCreateView(
        ...
        mViewModel.onRoadTripLiveData.observe(viewLifecycleOwner, Observer {
    ...
    private fun initFn() {
        ...
        mViewModel.callOnRoadTrips(userId,role,currentPage)
    }
    ...
    private fun callAdapter() {
        val tripsAdapter = TripsAdapter(requireActivity(), AppConstant.ONROAD,enquiryList,this)
